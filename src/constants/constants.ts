...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the UptimeAI documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "UptimeAI: Create, Chain, Communicate.",
  ...
  "Design Dialogues with UptimeAI.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret UptimeAI API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "UptimeAI Chat";
...
export const STORE_TITLE = "UptimeAI Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your UptimeAI API key.";
